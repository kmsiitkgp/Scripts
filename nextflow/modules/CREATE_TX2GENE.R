...
create_tx2gene <- function(output_dir, ref_gtf_path = NULL, species = NULL,
  ...
  if (is.null(ref_gtf_path) && !is.null(species)) {
    ...
    log_info(sample = species, step = "create_tx2gene",
  ...
  if (!exists("tx2gene")) {
    log_error(sample = "", step = "create_tx2gene",
  ...
  log_info(sample = "", step = "create_tx2gene",
