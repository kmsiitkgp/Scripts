...
def median_scale(data, clip=None):
    # pandas .mad() was removed in v2.0; it computed mean absolute deviation
    # from the mean (not true MAD). Replicate exactly to preserve numerical
    # equivalence with the original BostonGene results.
