#!/bin/bash
# =========================================================================================
# SCRIPT: build_spaceranger.sh
# =========================================================================================
# Purpose: Build Space Ranger Singularity/Apptainer image for HPC or local environments
#
# What it does:
#   1. Downloads Space Ranger tarball from 10x Genomics (if not present)
#   2. Builds Singularity image using spaceranger.def definition file
#   3. Validates image integrity by checking Space Ranger version
...
#     ls -lh
#   Should see: spaceranger.def, spaceranger-4.0.1.tar.gz (or will download)
#
# Step 5: Build the image
#     sudo apptainer build spaceranger_4.0.1.sif spaceranger.def
#   Note: This may take 15-30 minutes
#
# Step 6: Verify image
#     singularity exec spaceranger_4.0.1.sif spaceranger --version
#   Should output: spaceranger spaceranger-4.0.1
#
# Step 7: Upload to HPC
#   - Copy spaceranger_4.0.1.sif to your HPC singularity_cache directory
#   - Use scp, rsync, or your institution's data transfer tool
#   Example:
#     scp spaceranger_4.0.1.sif username@hpc.edu:/path/to/singularity_cache/
#
# Troubleshooting WSL:
...
#   - Build fails → Check spaceranger.def file is present and valid
# =========================================================================================
...
# Space Ranger version and download details
VERSION="4.0.1"
TAR_FILE="spaceranger-${VERSION}.tar.gz"
IMG_NAME="spaceranger_${VERSION}.sif"
IMG_SCRIPT="spaceranger.def"

# Download URL from 10x Genomics (with signed authentication)
# Note: This URL may expire - get fresh URL from: https://www.10xgenomics.com/support/software/space-ranger/downloads
...
echo "================================================================================"
echo "Space Ranger ${VERSION} Singularity Image Build"
echo "================================================================================"
...
echo "Step 3: Obtaining Space Ranger tarball..."
echo ""
...
if [ -f "${TAR_FILE}" ]; then
    ...
    wget -c -O "${TAR_FILE}" "${DOWNLOAD_URL}" || {
        ...
        echo "  https://www.10xgenomics.com/support/software/space-ranger/downloads"
        echo ""
...
echo ""
echo "Running: singularity exec ${IMG_NAME} spaceranger --version"
echo ""

# Critical validation: Verify Space Ranger works in the image
if singularity exec "${IMG_NAME}" spaceranger --version; then
    echo ""
    echo "================================================================================"
    echo "✓ VALIDATION PASSED: Space Ranger is functional"
    echo "================================================================================"
    echo ""
else
    echo ""
    echo "================================================================================"
    echo "✗ VALIDATION FAILED: Space Ranger version check failed"
    echo "================================================================================"
    echo ""
    echo "The image built successfully but Space Ranger cannot execute."
...
echo "  Size: ${IMG_SIZE}"
echo "  Version: Space Ranger ${VERSION}"
echo ""
echo "Next steps:"
echo "  1. Test the image:"
echo "     singularity exec ${IMG_NAME} spaceranger --help"
echo ""
...
#           sudo singularity build spaceranger_4.0.1.sif spaceranger.def
...
#           1. Visit: https://www.10xgenomics.com/support/software/space-ranger/downloads
#           2. Right-click download link → Copy link address
#           3. Update DOWNLOAD_URL variable in this script
#
# Problem: "spaceranger: command not found" after build
# Solution: Definition file issue. Verify:
#           1. Tarball extracted correctly
#           2. PATH set correctly in definition file
#           3. Space Ranger binaries are executable
#
# Problem: Validation passes but pipeline fails
# Solution: Test Space Ranger commands manually:
#           singularity exec spaceranger_4.0.1.sif spaceranger testrun --id=tiny
