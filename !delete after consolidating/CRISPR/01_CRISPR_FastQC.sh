...
#$ -l mem_free=16G               # Request memory
#$ -j y                         # Merge standard output and standard error
#$ -cwd                         # Set current working directory
#$ -t 1-30                      # Submit an array job with 1 task for each fq.gz file. 
...
input=(/common/theodorescudlab/Sequencing_Data/$proj/01.RawData/*.gz)
...
# proj="CRISPR_Jinfen"
# OUTPUT_DIR=$HOME/scratch/$proj/fastqc_results/
# multiqc --force \
