...
#$ -t 1-48                      # Submit an array job with 1 task for each fq.gz file. 
...
OUTPUT_DIR=$HOME/scratch/$proj/fastqc_results/      					# directory to store fastqc results
...
PATH=$HOME/NGSTools/jdk-24.0/bin/:$PATH
